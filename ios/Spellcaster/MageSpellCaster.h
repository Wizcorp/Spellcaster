...
@interface MageSpellCaster : NSObject <NSXMLParserDelegate, UIAlertViewDelegate>

@property (nonatomic, retain) CDVViewController *cordovaController;
@property (nonatomic, retain) MageReachability *networkMagic;
